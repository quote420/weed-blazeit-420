...
function SWEP:RCSAttack2()	
	...
	timer.Create( "idletimer", 1.2, 1, function() self:IdleAnimation(true) self.CantIdle = true end)
...
function SWEP:IdleAnimation(a)
	...
	self.CantIdle = false
	timer.Simple(12, function() self:IdleAnimation() end)  
...
function SWEP:Deploy()
	...
	timer.Create( "idletimer", 0.9, 1, function() self:IdleAnimation(true) self.CantIdle = true end)
	return true
end
