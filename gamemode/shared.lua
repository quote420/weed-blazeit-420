...
TEAM_MILI = AddExtraTeam("Civil Protection Military", {
	...
	description = [[Military police are Civil Protection
	that are meant to invade and kill
	the bases of criminals that are
	too well armed to be arrested.]],
	weapons = {"rcs_m4a1", "stunstick", "door_ram"},
	command = "military",
	max = 3,
	salary = 65,
	admin = 0,
...
TEAM_SNIPER = AddExtraTeam("Civil Protection Military Sniper", {
	...
	description = [[A Military CP that is
	armed with a sniper rifle.]],
	weapons = {"rcs_scout", "stunstick", "door_ram"},
	command = "sniper",
	max = 2,
	salary = 65,
	admin = 0,
...
TEAM_SNIPER = AddExtraTeam("Civil Protection Military Commander", {
	...
	description = [[A Military CP that leads
	the others.]],
	weapons = {"rcs_aug", "stunstick", "door_ram"},
	command = "commander",
	max = 1,
	salary = 75,
	admin = 0,
...
TEAM_CAMERA = AddExtraTeam("\"Photographer\"", {
	...
	description = [[A member of the Indie Film Company
	known as the Kool Kamera Krew.
	Run at people and take images of them to place on food boxes.]],
	weapons = {},
	command = "cameraman",
	max = 6,
	salary = 50,
...
TEAM_CHIEF = AddExtraTeam("Civil Protection Chief", {
	...
	weapons = {"arrest_stick", "unarrest_stick", "rcs_deagle", "stunstick", "door_ram", "weaponchecker"},
	command = "chief",
	max = 1,
	salary = 75,
	admin = 0,
...
*/
AddDoorGroup("Cops and Mayor only", TEAM_CHIEF, TEAM_POLICE, TEAM_MAYOR, TEAM_SNIPER, TEAM_MILI)
...
AddAgenda("Police agenda", TEAM_MAYOR, {TEAM_CHIEF, TEAM_POLICE, TEAM_SNIPER, TEAM_MILI})
